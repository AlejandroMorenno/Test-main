...
?>
        ...
        <main>
            <form action="include/login.php" method="post" class="row g-3 col-md-6" style="width: 400px" ;>
                <h2>Вход</h2>
                <div class="col-md-12">
            ...
            <form action="registration.php" method="post" class="row g-1 col-md-6" style="width: 300px" ;>

                <button style="POSITION: RELATIVE; TOP: -38PX; RIGHT: -40PX;" type="submit" class="btn btn-primary">Регистрация</button>
            </form>
